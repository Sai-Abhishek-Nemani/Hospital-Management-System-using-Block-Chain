...
PreparedStatement pst =con.prepareStatement("select email from doct where id='"+session.getAttribute("docid")+"' ");

String emaill="";
Random r = new Random( System.currentTimeMillis() );
String rr= session.getAttribute("dotpis").toString();//((1+ r.nextInt(9)) * 10000 + r.nextInt(10000));

session.setAttribute("dotpis", rr);
//out.println(rr);
...
<a href="docotp.jsp"">Get OTP Again</a>
