...
<table >
<tr><td><form action="shadtails2.jsp">   <input type="text" placeholder="Enter Hash Value" minlength="40" maxlength="40" name="iid" required="required"> <input type="submit"> </form></td></tr>
...
<h3 style="font-weight: bold;color: blue;">My Report Hash Data</h3>
