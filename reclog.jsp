...
PreparedStatement pst =con.prepareStatement("select count(*),id from recp where email='"+a1+"' and pass='"+a2+"'");
...
if(a==0){
	response.sendRedirect("reception.jsp?m=Login Details Wrong");
	
}
else if(a==1){
	
	session.setAttribute("recid", recid);
	response.sendRedirect("rechome.jsp");
