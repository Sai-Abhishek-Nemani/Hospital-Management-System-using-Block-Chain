...
<%
//out.println(session.getAttribute("piid"));

Class.forName("com.mysql.jdbc.Driver");
Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/medicalreport","root","root");
PreparedStatement pst =con.prepareStatement("select *,AES_DECRYPT(record,'key') from pati where id='"+session.getAttribute("piid")+"'");
...
%>
				...
				<tr>
					<th> Report</th>
					<td><textarea rows="6" cols="30"readonly="readonly" ><%=rs.getString(12) %></textarea></td>
				</tr>
