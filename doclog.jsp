...
PreparedStatement pst =con.prepareStatement("select count(*),id from doct where email='"+a1+"' and pass='"+a2+"'");
...
if(a==0){
	response.sendRedirect("doc.jsp?m=Login Details Wrong");
	
}
else if(a==1){
	
	session.setAttribute("docid", recid);
