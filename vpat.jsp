...
<!-- 		<li><a href="vphar.jsp">View Pharmacies</a></li>
...
PreparedStatement pst =con.prepareStatement("select * from pati");
...
<td><a href="adetails.jsp?id=<%=rs.getString(1) %>" style="color:red;"><b>Details</b></a></td>
<%-- <td><a href="shadtails.jsp?id=<%=rs.getString(1) %>" style="color:pink;"><b>View</b></a></td>
 --%>
</tr>
<%} %>
</table>
