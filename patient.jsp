...
<div align="center">
<form action="patlog.jsp" style="">
<h3 style="font-weight: bold;color: blue;">Patient Login</h3>
<table>

<tr><td>ID</td><td><input type="text" name="name" required="required"></td></tr>
<tr><td>Password</td><td><input type="password" name="pass" required="required"></td></tr>

</table>
<input type="submit" value="login">
<br>
<b>Forget Password <a href="forget.jsp">Here</a></b>
</form>
