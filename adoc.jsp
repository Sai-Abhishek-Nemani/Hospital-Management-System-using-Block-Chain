  ...
  <div class="container"> 
    ...
    <h1 style="font-weight: bold;color: red">Enhancing Data Security in Cloud Using Blockchain</h1></br>
      <ul class="nav navbar-nav">
        ...
        <li class="active"> <a href="adoc.jsp">Add Doctor</a> </li>
...
<h3 style="font-weight: bold;color: blue;">Doctor Details</h3>
<table>

<tr><td>Doctor Name</td><td><input type="text" name="a1" required="required"></td></tr>
<tr><td>Department</td><td><input type="text" name="a2" required="required"></td></tr>
<tr><td>Number</td><td><input type="number" name="a3" required="required"></td></tr>
<tr><td>Email</td><td><input type="email" name="a4" required="required"></td></tr>
